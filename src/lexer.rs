    ...
    while let Some(&c) = chars.peek() {
        match c {
            ...
            '/' => {
                chars.next();
                if chars.peek() == Some(&'/') {
                    while let Some(x) = chars.next() { if x == '\n' { break; } }
            ...
            ':' => { chars.next(); out.push(Token::Colon); }
            ...
            '"' => {
                ...
                if !closed { return Err("unterminated string".into()); }
            ...
            c if c.is_ascii_alphabetic() || c == '_' => {
                ...
                out.push(match s.as_str() {
                    ...
                    "true" => Token::True, "false" => Token::False, "if" => Token::If,
